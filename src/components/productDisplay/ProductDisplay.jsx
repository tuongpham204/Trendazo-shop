...
const ProductDisplay = ({ product }) => {
  ...
  return (
    <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 font-sans my-12">
        ...
        <div className="flex gap-3">
          {[1, 2, 3, 4].map((i) => (
            <img
              ...
              src={product.image}
              alt="thumbnail"
              className="w-24 h-24 object-cover rounded-md border border-gray-200 cursor-pointer hover:ring-2 hover:ring-emerald-500 transition"
            />
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col">
        <p className="text-sm text-emerald-600 font-medium mb-1">Men Fashion</p>
        ...
        <div className="flex items-center mb-6 text-sm text-gray-600">
          ...
          <FontAwesomeIcon icon={regularStar} className="text-yellow-400" />
        </div>

        {product.category !== "other" && (
          <div className="mb-6">
            <h2 className="text-gray-800 text-base font-medium mb-3">
              Select Size
            </h2>
        ...
        <button
          ...
          className="w-full sm:w-80 py-3 rounded-lg bg-black text-white font-semibold text-sm hover:bg-gray-800 transition mb-6"
        >
          Add to Cart
        </button>
        ...
        <div className="border border-gray-200 rounded-lg p-4 grid grid-cols-2 gap-6 text-sm text-gray-700">
          <div>
            <p className="font-medium text-gray-900 flex items-center gap-2">
              <FontAwesomeIcon icon={faTruck} className="text-emerald-600" />
              Delivery
            </p>
            <p className="mt-1 text-gray-600">10–12 October 2024</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-gray-600">3–6 Working Days</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1">Modern, Casual, Trending</p>
          </div>
        </div>
      </div>
    </div>
