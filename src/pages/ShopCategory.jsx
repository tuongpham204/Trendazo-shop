  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="text-center max-w-2xl mx-auto mb-10">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 uppercase font-serif">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <MenuButton className="inline-flex justify-center items-center gap-x-1.5 rounded-full border border-gray-300 bg-white px-5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-100 focus:outline-none">
              Sort by
              <ChevronDownIcon
                aria-hidden="true"
      ...
      {showing < totalProduct && (
        <div
          ...
          className="cursor-pointer mt-16 mx-auto w-48 h-12 flex items-center justify-center rounded-full bg-gray-900 text-white text-sm font-semibold hover:bg-gray-800 transition duration-300 shadow"
        >
          LOAD MORE
        </div>
      )}
